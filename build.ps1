...
& java -jar swagger-codegen-cli-2.4.5.jar generate -i .\fraud-api-swagger.json -l csharp -o client -c packageconfig.json
...
(Get-Content ./client/README.md).replace(' automatically generated by the [Swagger Codegen](https://github.com/swagger-api/swagger-codegen) project', " for the [Cloudmersive AI Fraud Detection API](https://cloudmersive.com/ai-fraud-detection-api)") | Set-Content ./client/README.md
